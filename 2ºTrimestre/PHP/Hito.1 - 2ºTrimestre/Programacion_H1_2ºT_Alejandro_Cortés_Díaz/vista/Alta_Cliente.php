...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $PaquetesAdicionalesExtra = isset($_POST['PaquetesExtra']) ? $_POST['PaquetesExtra'] : ''; 
    $Duracion = $_POST['Duracion']; 
    
    // Creo un objeto de la clase Socio para poder agregar clientes
    $controller = new SociosController();
    if($PaquetesAdicionalesExtra=='PaquetesExtra'){
...
<div class="container mt-5">
    ...
    <!-- Formulario para añadir un cliente por los datos básicos -->
    <form action="Alta_Cliente.php" method="POST" class="row g-3">
        <div class="col-md-12">
